...
| `SUB_LINKxx_PROXY` | `DIRECT` | Specifies through which [proxy](https://wiki.metacubex.one/ru/config/proxy-providers/#proxy) the subscription should be fetched. Example: `SUB_LINK1_PROXY` with value `proxies1` → the subscription will be downloaded via the proxy `proxies1` |
